...
GO
exec Procedures_AdvisorCreate
select* from Graduation_Plan
update student 
set acquired_hours = 160
select* from Graduation_plan
...
select* from Graduation_Plan
select* from course
insert into Course Values('cs','Eng',1,2,1);
select* from GradPlan_Course
truncate table GradPlan_Course
DELETE FROM Graduation_Plan WHERE plan_id =3;
DELETE FROM Course WHERE plan_id =3;
select* from student
------------------------------------------------------------------------------
...
go
insert into Request values('credit_hours',null,'Pending',null,1,2,1);
insert into Request values('credit_hours',null,'Pending',null,2,2,1);
insert into Request values('course',null,'Accepted',3,1,2,1);
...
select* from Graduation_Plan
insert into course values('db','Eng',1,3,2);
insert into course values('db2','Eng',1,3,2);
select* from GradPlan_Course
insert into student values ('ali','assem','123',1.32,'met','ali.com','Eng',1,2,157,15,1);
insert into request values('credit_hours',null,'pending',3,null,1,1);
insert into request values('course',null,'pending',null,9,1,1);
insert into request values('course',null,'pending',null,8,1,1);
insert into request values('course',null,'pending',null,7,1,1);
insert into request values('course',null,'pending',null,11,11,1);
insert into request values('credit_hours',null,'pending',2,null,11,1);

select* from course
select* from request
select* from student
insert into Student_Instructor_Course_take values(11,10,10,'S24',null,null);
select* from Student_Instructor_Course_take;
Go
...
insert into Student values('diana','rehan','123',null,'met','diana.com','Eng',1,7,157,16,1);
select* from Student;
select* from advisor
go

Create PROC [Procedures_AdvisorViewAssignedStudents2]
@AdvisorID int
As

Select Student.student_id, Student.f_name+' ' + Student.l_name as Student_name
from Student 
where Student.advisor_id = @AdvisorID 
Go
EXEC Procedures_AdvisorViewAssignedStudents2 @AdvisorID = 1; -- Replace 123 with an actual advisor ID
